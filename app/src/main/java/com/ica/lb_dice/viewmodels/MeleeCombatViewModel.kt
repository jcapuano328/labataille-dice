...
class MeleeCombatViewModel : ViewModel() {
    ...
    private fun createDiceSets() {
        _diceSetAttackerPreMeleeMorale.value = DiceSet(listOf(DieConfig(backgroundColor = Color.Black, dotColor = Color.White), DieConfig(backgroundColor = Color.Black, dotColor = Color.Red)), MutableStateFlow(emptyList()))
        _diceSetDefenderPreMeleeMorale.value = DiceSet(listOf(DieConfig(backgroundColor = Color.Black, dotColor = Color.White), DieConfig(backgroundColor = Color.Black, dotColor = Color.Red)), MutableStateFlow(emptyList()))
        _diceSetMelee.value = DiceSet(listOf(DieConfig(backgroundColor = Color.Red, dotColor = Color.White), DieConfig(backgroundColor = Color.White, dotColor = Color.Black)), MutableStateFlow(emptyList()))
