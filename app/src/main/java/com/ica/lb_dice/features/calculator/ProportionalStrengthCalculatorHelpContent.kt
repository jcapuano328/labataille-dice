        ...
        LazyColumn(
            ...
            item {
                HelpSection(title = "+ (PLUS)") {
                    BulletPoint(text = "Add a full strength unit (no losses) to the accumulated result.")
                    Spacer(Modifier.height(4.dp))
                    ...
                    BulletPoint(text = "Use the number pad to enter a value.")
                    BulletPoint(text = "Use the PLUS button to add to total.")
                    Spacer(Modifier.height(16.dp))
                }
            }
                ...
                HelpSection(title = "Example: Calculate the total melee strength of 3 units") {
                    ...
                    */
                    ...
                    Column(Modifier.padding(start = 16.dp)) {
                        ...
                        BulletPoint(text = "The Green accumulator area shows the value 12.5")
                        BulletPoint(text = "Tap the ATT button")
                        Column(Modifier.padding(start = 16.dp)) {
                            BulletPoint(text = "The Attack value on the main screen is set to 12.5")
                            BulletPoint(text = "The Green accumulator area is cleared")
                        }
                    }
                    ...
                    Column(Modifier.padding(start = 16.dp)) {
                        ...
                        BulletPoint(text = "The Green accumulator area shows the value 11")
                        BulletPoint(text = "Tap the ATT button")
                        Column(Modifier.padding(start = 16.dp)) {
                            BulletPoint(text = "The Attack value on the main screen is set to 23.5")
                            BulletPoint(text = "The Green accumulator area is cleared")
                        }
                    }
                    ...
                    Column(Modifier.padding(start = 16.dp)) {
                        ...
                        BulletPoint(text = "Tap the STR button")
                        BulletPoint(text = "The Green accumulator area shows the value 7.5")
                        BulletPoint(text = "Tap the ATT button")
                        Column(Modifier.padding(start = 16.dp)) {
